...
@Component({
  selector: 'app-reject-payment-proof-dialog',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  template: `
    <h2 mat-dialog-title>Rejeitar comprovativo</h2>
...
export class RejectPaymentProofDialogComponent {
  reason = this.fb.control('', [Validators.required, Validators.minLength(10), Validators.maxLength(2000)]);

  constructor(
    private fb: FormBuilder,
    public dialogRef: MatDialogRef<RejectPaymentProofDialogComponent, string | undefined>
  ) {}
